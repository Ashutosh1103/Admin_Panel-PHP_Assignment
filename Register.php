...
// error variables 
$nameErr = $emailErr = $con_passwordErr = $passwordErr = $imageErr = $ageErr = $genderErr = $capErr = "";
...
if (isset($_POST["sub"])) {
    ...
    if ($nameErr === "" && $emailErr === "" && $con_passwordErr === "" && $passwordErr  === "" && $ageErr ==  "" && $imageErr === ""  && $genderErr === "") 
    {
